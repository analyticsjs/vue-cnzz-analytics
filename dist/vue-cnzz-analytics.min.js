...
!(function (t, e) {
  ...
  var e = (function () {
      ...
      return (
        ...
        (t.prototype.trackPageview = function (t, e) {
          if (((t && 'string' == typeof t) || (t = '/'), t.includes('http'))) {
            var n = t.split('/'),
              i = n[0] + '//' + n[2]
            t = t.replace(i, '')
          }
          ;(!e || (e && 'string' != typeof e)) && (e = ''),
            'string' != typeof e || e.includes('http') || (e = ''),
            this.setAccount(),
            e
              ? window._czc.push(['_trackPageview', t, e])
        ...
        (t.prototype.trackEvent = function (t, e, n, i, o) {
          ...
          ;(n && 'string' == typeof n) || (n = ''),
            ...
            this.setAccount(),
            o
              ? window._czc.push(['_trackEvent', t, e, n, i, o])
              : window._czc.push(['_trackEvent', t, e, n, i]),
            this.isDebug &&
              console.log(
    ...
    n = (function () {
      function t(t, e) {
        ;(this.siteIdList = (function (t, e, n) {
      ...
      return (
        (t.prototype.init = function () {
          ...
          this.siteIdList.forEach(function (n) {
            new e(n, t.isDebug).init()
          })
        }),
        (t.prototype.pv = function (t, n) {
          var i = this
          this.siteIdList.forEach(function (o) {
            new e(o, i.isDebug).trackPageview(t, n)
          })
        }),
        (t.prototype.event = function (t, n, i, o, s) {
          var c = this
          this.siteIdList.forEach(function (r) {
            new e(r, c.isDebug).trackEvent(t, n, i, o, s)
          })
        }),
        t
      )
  ...
  ;(t.default = function (t, e) {
    ...
    switch (
      ...
      case 2:
        t.prototype.$pushCNZZ = u
        break
      case 3:
        t.config.globalProperties.$pushCNZZ = u
    }
    ...
    (t.usePush = function () {
      return {
        pv: function (t, e) {
          return i.pushCNZZ.pv(t, e)
        },
        event: function (t, e, n, o, s) {
          return i.pushCNZZ.event(t, e, n, o, s)
        },
      }
    }),
